...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "xprate",         SEC_ADMINISTRATOR,         false, &ChatHandler::HandleModifyXpRateCommand,        "", nullptr },
    ...
    {
        { "find",           SEC_DEVELOPER,     true,  &ChatHandler::HandleClientSearchCommand,        "", nullptr },
        { "",               SEC_DEVELOPER,     true,  &ChatHandler::HandleClientInfosCommand,         "", nullptr },
        { nullptr,          0,                  false, nullptr,                                        "", nullptr }
    };

    static ChatCommand anticheatCommandTable[] =
    {
        { "server",         SEC_DEVELOPER,     true,  &ChatHandler::HandleAnticheatCommand,            "", nullptr },
        { "client",         SEC_DEVELOPER,     true, nullptr,                                          "", anticheatClientCommandTable },
        { nullptr,          0,                  false, nullptr,                                         "", nullptr }
    };
    static ChatCommand replayCommandTable[] =
    {
        { "play",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleReplayPlayCommand,           "", nullptr },
        { "forward",        SEC_BASIC_ADMIN,  false, &ChatHandler::HandleReplayForwardCommand,        "", nullptr },
        { "stop",           SEC_BASIC_ADMIN,  false, &ChatHandler::HandleReplayStopCommand,           "", nullptr },
        { "record",         SEC_BASIC_ADMIN,  false, &ChatHandler::HandleReplayRecordCommand,         "", nullptr },
    ...
    {
        { "mute",               SEC_TICKETMASTER,      true,  &ChatHandler::HandleSpamerMute,                "", nullptr },
    ...
    static ChatCommand AntiSpamCommandTable[] =
    {
        ...
        { "remove",             SEC_ADMINISTRATOR,    true,  &ChatHandler::HandleAntiSpamRemove,             "", nullptr },
        { "replace",            SEC_ADMINISTRATOR,   true,  &ChatHandler::HandleAntiSpamReplace,            "", nullptr },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "replay",         SEC_DEVELOPER,  false, nullptr,                                        "", replayCommandTable   },
        ...
        { "revive",         SEC_TICKETMASTER,     true,  &ChatHandler::HandleReviveCommand,              "", nullptr },
        { "mount",          SEC_GAMEMASTER,     false, &ChatHandler::HandleMountCommand,               "", nullptr },
        { "dismount",       SEC_ADMINISTRATOR,         false, &ChatHandler::HandleDismountCommand,            "", nullptr },
